...
const initialApps: AppItem[] = [
  ...
  { id: "email-bozzer", name: "Notes", description: "Bozze email pronte da inviare", icon: <Mail className="w-6 h-6" />, active: true, free: true, url: "/email-bozzer", color: "bg-accent-orange/10 text-accent-orange-text" },
